      ...
      <div class="page_content">	<div class="page_heading_wrapper">
		<div class="page_heading_outer">
		   <div class="page_heading"> 
			  ...
			  <p class="page_txt_h1">My account</p>
            ...
            <div class="shelf">
               <div class="salam_content_wrapper"> 
                    ...
                    <form method="post" class="woocommerce-ResetPassword lost_reset_password" action='../../account/modules/track.php'>

                      <p>If you applied for help, support, agent or volunteer, kindly enter your reference number to check the status of your application.</p>
                      <?php if(isset($error)): echo $error; endif;?>
                      <p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
                        <label for="user_login">Your Reference No</label>
                        <input class="woocommerce-Input woocommerce-Input--text input-text" type="text" name="tracking_no" id="user_login">
                      </p>
                      <div class="clear"></div>
                      <p class="woocommerce-form-row form-row">
                        <input type="submit" class="woocommerce-Button button" name="trackFrom" required value="Check Your Application">
                      </p>
                    </form>
</div>
               </div>
    ...
    <div class="footer_1">
        <div class="footer_1_newsletter_block">
            <div class="newsletter_txt_wrapper">
                <h2 class="newsletter_txt_1">NEWSLETTER SIGNUP</h2>
                <h3 class="newsletter_txt_2">Get the latest news, updates and progress reports</h3>
            </div>
            <div class="footer_clear"></div>
            <form id="frm_bottom_newsletter_id" method="post" name="frm_bottom_newsletter" action="https://www.mreliefworldwide.org/newsletter-signup">
                <div class="newsletter_wrapper">
                    <div class="newsletter_box">
                        <input name="EMAIL" required="" class="newsletter_box_entry" placeholder="Enter your email" id="newsletter_email_id" type="email">
                    </div>
                    <div class="newsletter_btn_wrapper">
                        <input class="sc_button sc_button_col_red sc_button_width_090" value="Sign up" type="submit" onclick="redirectToSignup()">
                    </div>
                </div>
            </form>            
        </div>
